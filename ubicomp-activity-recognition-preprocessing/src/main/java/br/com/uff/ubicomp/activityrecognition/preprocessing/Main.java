...
energyPositionActivity = new EnergyPositionActivity(codUser, Date.from(time.atDate(LocalDate.of(2017, 05, 22)).atZone(ZoneId.systemDefault()).toInstant()), user_position, act, Environment.getMeasurementOfEnvironment(Environment.ROOM, act, time), Environment.getMeasurementOfEnvironment(Environment.BEDROOM, act, time), Environment.getMeasurementOfEnvironment(Environment.BATHROOM, act, time), Environment.getMeasurementOfEnvironment(Environment.KITCHEN, act, time), Environment.getMeasurementOfEnvironment(Environment.EXTERNAL_AREA, act, time));
